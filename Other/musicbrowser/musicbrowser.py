...
Lists Artists, their albums and the albu tracks pulled from a SQLite3 DB
The browser is a Tkinter window
...
class DataListBox(Scrollbox):
    ...
    def on_select(self, event):
        if self.linked_box:
            ...
            print('sql_select=', self.sql_select)
